...
<link href="assets/css/bootstrap.min.css" rel="stylesheet"
	type="text/css" />
<link class="ace-main-stylesheet" id="main-ace-style" href="assets/css/ace.min.css" rel="stylesheet">
...
<body>
	...
	<center>
		...
		<br>
		<!-- Start of Email Form -->
		<form method="post" action="SubmitEmail.html"
			enctype="multipart/form-data" class="form-horizontal">
			<fieldset>
				<!-- start of form group div -->
				<!-- initial recipients field -->
				
				
				<!--  
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-1"> To &nbsp; &nbsp;</label> <input class="col-xs-10 col-sm-5"
						id="form-field-1" type="text" placeholder="Enter Recipients"
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						...
						<input class="col-xs-10 col-sm-5" id="form-field-1" type="text"
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right"
						for="form-field-1"> Message &nbsp; &nbsp;</label>

					
						<textarea class="col-xs-10 col-sm-5" id="form-field-1"
							placeholder="Message" name="message" rows=10 cols=50></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<input id="my-file-selector" name="fileUpload" type="file" multiple>
				</div>
